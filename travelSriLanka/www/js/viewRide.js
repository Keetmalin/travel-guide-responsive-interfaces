...
window.onload = function() {
    index = sessionStorage.getItem("rideIndex");
    document.getElementById("makePayment").addEventListener("click", makePayment);

    jQuery.ajax({
        type: "GET",
        url: 'http://localhost/travelSL/web/user/ridePage',
        dataType: 'json',
        ...
        success: function (obj, textstatus) {
            ...
            document.getElementById('modalTelephone').innerText = 'Vehicle: ' + obj.result[index].Vehicle;
            document.getElementById('modalAddress').innerText = 'Capacity: ' + obj.result[index].Capacity;
...
//make payment fronction which will store payment details in the website
...
function makePayment(){
    ...
    jQuery.ajax({
        type: "GET",
        url: 'http://localhost/travelSL/web/app_dev.php/user/ridePage',
        dataType: 'json',
        success: function (obj, textstatus) {
