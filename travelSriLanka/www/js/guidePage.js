...
window.onload = function() {
    jQuery.ajax({
        type: "GET",
        url: 'http://localhost/travelSL/web/user/guidePage',
        dataType: 'json',
...
//call a button and pass the values of the respective index,to be shown in the following window
function loadModalOne() {
    sessionStorage.setItem("guideIndex", 0);
}
function loadModalTwo() {
    sessionStorage.setItem("guideIndex", 1);
}
function loadModalThree() {
    sessionStorage.setItem("guideIndex", 2);
}
function loadModalFour() {
    sessionStorage.setItem("guideIndex", 3);
}
function loadModalFive() {
    sessionStorage.setItem("guideIndex", 4);
}
function loadModalSix() {
    sessionStorage.setItem("guideIndex", 5);
}
function loadModalSeven() {
    sessionStorage.setItem("guideIndex", 6);
}
function loadModalEight() {
    sessionStorage.setItem("guideIndex", 7);
}
function loadModalNine() {
    sessionStorage.setItem("guideIndex", 8);
}
function loadModalTen() {
    sessionStorage.setItem("guideIndex", 9);
}
function loadModalEleven() {
    sessionStorage.setItem("guideIndex", 10);
}
function loadModalTwelve() {
    sessionStorage.setItem("guideIndex", 11);
}
//set listeners to the view buttons of all sections
