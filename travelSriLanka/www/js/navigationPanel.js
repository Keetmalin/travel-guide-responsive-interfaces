...
// pass index to the next page, of the unit selectsed
function loadModalOne() {
    sessionStorage.setItem("photographerIndex", 0);

}
function loadModalTwo() {
    sessionStorage.setItem("photographerIndex", 1);
}
function loadModalThree() {
    sessionStorage.setItem("photographerIndex", 2);
}
function loadModalFour() {
    sessionStorage.setItem("photographerIndex", 3);
}
function loadModalFive() {
    sessionStorage.setItem("photographerIndex", 4);
}
function loadModalSix() {
    sessionStorage.setItem("photographerIndex", 5);
}
function loadModalSeven() {
    sessionStorage.setItem("photographerIndex", 6);
}
function loadModalEight() {
    sessionStorage.setItem("photographerIndex", 7);
}
function loadModalNine() {
    sessionStorage.setItem("photographerIndex", 8);
}
function loadModalTen() {
    sessionStorage.setItem("photographerIndex", 9);
}
function loadModalEleven() {
    sessionStorage.setItem("photographerIndex", 10);
}
function loadModalTwelve() {
    sessionStorage.setItem("photographerIndex", 11);
}
//set listeners to all the view buttons in the page
