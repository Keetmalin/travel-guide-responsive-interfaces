...
function loadPolice() {
    ...
    jQuery.ajax({
        type: "GET",
        url: 'http://localhost/travelSL/web/user/loadPolice',
        dataType: 'json',
...
function loadHospital() {
    ...
    jQuery.ajax({
        type: "GET",
        url: 'http://localhost/travelSL/web/user/loadHospital',
        dataType: 'json',
        success: function (obj, textstatus) {
...
function loadAirLine() {
    ...
    jQuery.ajax({
        type: "GET",
        url: 'http://localhost/travelSL/web/user/loadAirLine',
        dataType: 'json',
        success: function (obj, textstatus) {
...
function loadBank() {
    ...
    jQuery.ajax({
        type: "GET",
        url: 'http://localhost/travelSL/web/user/loadBank',
        dataType: 'json',
        success: function (obj, textstatus) {
...
function addNewContact() {
    ...
    jQuery.ajax({
        type: "GET",
        url: 'http://localhost/travelSL/web/user/addNewContact',
        dataType: 'json',
